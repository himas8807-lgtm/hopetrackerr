...
const _WAVE_SONGS = [
    ...
    { day: 7, id: 'truth-untold', title: 'The Truth Untold', artist: 'BTS', album: 'LOVE YOURSELF 結 Answer', era: '🌹', bpm: 76, color: '#a855f7', wave: 'slow-sway', spotifyId: '4eP8Syl3aBEQw3Jy5Bhq0D', lyric: '"말하지 못한 진심"', lyricEn: '"The truth I couldn\'t say"' },    { day: 8, id: 'butterfly', title: 'Butterfly', artist: 'BTS', album: 'HYYH pt.2', era: '🦋', bpm: 82, color: '#c4b5fd', wave: 'flutter', spotifyId: '3PcB8JkN4YODRLRghYAiUY', lyric: '"넌 내게로 날아와"', lyricEn: '"You flew to me"' },
